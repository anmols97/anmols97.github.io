      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <Container className="relative z-20 max-w-4xl text-center">
          <div className="space-y-8">
            <h1
              className={`text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight ${dark ? 'text-white' : 'text-gray-900'}`}
            >
            ...
            <div
              className={`space-y-6 text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto ${dark ? 'text-white/90' : 'text-gray-800'}`}
            >
              <p>
